    ...
    <div class="card-body">
        ...
        <div class="form-group mb-3">
            ...
            <input type="text" class="form-control" id="images" name="images"
                value="{{ old('title', $post->images) }}">
        </div>
        <div class="form-group mb-3">
            <label for="title">Category</label>
            <input type="text" class="form-control" id="category" name="category"
                value="{{ old('title', $post->category) }}">
        </div>
        <div class="form-group mb-3">
        ...
        <div class="form-group mb-3">
            ...
            <div class="form-check form-check-inline">
                <input type="radio" class="form-check-input" id="publishedYes"
                    name="published" value="yes"
                    {{ $post->published == 'yes' ? 'checked' : '' }}>
                <label class="form-check-label" for="publishedYes">Yes</label>
            </div>
            <div class="form-check form-check-inline">
                <input type="radio" class="form-check-input" id="publishedNo"
                     name="published" value="no"
